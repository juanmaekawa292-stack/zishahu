    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between"><span className="text-muted-foreground">小计</span><span className="font-medium">{formatPrice(order.subtotal)}</span></div>
          ...
          <div className="flex justify-between"><span className="text-muted-foreground">税费</span><span className="font-medium">{formatPrice(order.tax)}</span></div>
